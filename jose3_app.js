...
var SERVICIO_DATA = {
    1: {
        icon: '­ƒøü',
        descripcion: 'Un refugio de paz y armon├¡a en el coraz├│n del hotel. Nuestro Spa & Bienestar te invita a desconectar del mundo y entregarte al arte del cuidado personal. Con tratamientos dise├▒ados por expertos y ambientes de serenidad absoluta, cada visita es una experiencia transformadora.',
        caracteristicas: [
            'Masajes relajantes y terap├®uticos personalizados',
            'Jacuzzi privado climatizado',
            'Sauna finlandesa y ba├▒o de vapor',
            'Tratamientos faciales con productos de lujo',
            'Aromaterapia y cromoterapia',
            'Zona de relajaci├│n con infusiones de autor',
        ],
        horario: '09:00 ÔÇô 21:00',
        capacidad: 'Hasta 2 personas ┬À Reserva previa',
        images: [
    ...
    2: {
        icon: '­ƒì│',
        descripcion: 'Empieza el d├¡a con el mejor desayuno de tu vida. Nuestro Desayuno Premium es un fest├¡n de sabores locales e internacionales preparados cada ma├▒ana con los ingredientes m├ís frescos. Desde boller├¡a artesanal hasta zumos reci├®n exprimidos, cada detalle est├í pensado para deleitarte.',
        caracteristicas: [
            'Buffet gourmet con productos locales de temporada',
            'Boller├¡a artesanal horneada cada ma├▒ana',
            'Zumos naturales y batidos de frutas frescas',
            'Estaci├│n de huevos cocinados al momento',
            'Selecci├│n de quesos y embutidos ib├®ricos',
            'Servido en el restaurante con vistas al jard├¡n',
        ],
        horario: '07:00 ÔÇô 11:00',
        capacidad: 'Por persona ┬À Incluye bebidas calientes',
        images: [
    ...
    3: {
        icon: '­ƒÜù',
        descripcion: 'Llega y parte con la elegancia que mereces. Nuestro Servicio de Coche privado pone a tu disposici├│n un conductor profesional y un veh├¡culo de alta gama para que cada trayecto sea tan memorable como tu estancia. Traslados al aeropuerto, excursiones o simplemente moverse por la ciudad con estilo.',
        caracteristicas: [
            'Veh├¡culo de lujo (Mercedes Clase E o superior)',
            'Conductor profesional y discreto',
            'Traslados al aeropuerto y estaci├│n de tren',
            'Excursiones y visitas tur├¡sticas privadas',
            'Disponible las 24 horas con reserva previa',
            'Amenities de bienvenida a bordo',
        ],
        horario: '24 horas',
        capacidad: 'Hasta 4 pasajeros ┬À Reserva 2h antes',
        images: [
    ...
    4: {
        icon: '­ƒìÀ',
        descripcion: 'Una experiencia gastron├│mica que trasciende la mesa. Nuestra Cena Gourmet es una traves├¡a sensorial dise├▒ada por nuestro chef con inspiraci├│n en la alta cocina mediterr├ínea. Cada plato cuenta una historia, cada maridaje es una revelaci├│n. Para quienes entienden que cenar es mucho m├ís que comer.',
        caracteristicas: [
            'Men├║ degustaci├│n de 7 platos elaborados al momento',
            'Maridaje de vinos seleccionados por el sumiller',
            'Chef con formaci├│n en restaurantes con estrellas Michelin',
            'Ingredientes de proximidad y de temporada',
            'Mesa con vistas panor├ímicas al jard├¡n o la ciudad',
            'Opci├│n vegetariana y adaptaci├│n a alergias',
        ],
        horario: '19:30 ÔÇô 23:00',
        capacidad: 'M├íx. 12 comensales ┬À Reserva obligatoria',
        images: [
            'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=85',
    ...
    5: {
        icon: '­ƒÅï´©Å',
        descripcion: 'Mant├®n tu rutina sin sacrificar el lujo. Nuestro Gimnasio 24h cuenta con la maquinaria m├ís avanzada del mercado en un espacio dise├▒ado para inspirar el movimiento. Desde el cardio matutino hasta el entrenamiento de fuerza nocturno, el gimnasio est├í siempre listo para ti.',
        caracteristicas: [
            'Equipamiento Technogym de ├║ltima generaci├│n',
            'Zona de pesas libres y m├íquinas de musculaci├│n',
            'Cardio: cintas, el├¡pticas, bicicletas y remos',
            'Clases dirigidas de yoga, pilates y HIIT',
            'Entrenador personal disponible bajo reserva',
            'Vestuarios con sauna seca incluida',
        ],
        horario: '24 horas',
        capacidad: 'Acceso libre ┬À Clases con reserva previa',
        images: [
    ...
    6: {
        icon: '­ƒî┐',
        descripcion: 'El lujo de tenerlo todo sin salir de tu habitaci├│n. Nuestro Room Service opera las 24 horas con una carta completa que incluye desde desayunos ligeros hasta cenas elaboradas. Todo presentado con la misma excelencia que esperas de Hotel DAW, entregado en tu puerta en menos de 30 minutos.',
        caracteristicas: [
            'Disponible las 24 horas, todos los d├¡as del a├▒o',
            'Carta completa: desayuno, almuerzo, cena y snacks',
            'Entrega garantizada en menos de 30 minutos',
            'Presentaci├│n en vajilla de porcelana con cubiertos de plata',
            'Carta de vinos y c├│cteles disponible',
            'Opci├│n de mesa en habitaci├│n montada por el equipo',
        ],
        horario: '24 horas',
        capacidad: 'Para hu├®spedes del hotel',
        images: [
...
// ÔöÇÔöÇ FLATPICKR ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
function initFancyMonthDropdown(instance) {
    ...
    btn.textContent = instance.l10n.months.longhand[instance.currentMonth] + ' Ôû¥';
...
function syncFancyMonth(instance) {
    ...
    wrap.querySelector('.fp-month-btn').textContent = monthName + ' Ôû¥';
...
// ÔöÇÔöÇ INIT ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
async function init() {
    ...
    // Comprobar sesi├│n activa en el servidor
    try {
...
// ÔöÇÔöÇ COOKIES ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

function checkCookies() {
    // Si no est├í aceptada ni rechazada, mostramos el banner
    if (!document.cookie.includes('hotelDAW_cookies=')) {
        setTimeout(() => {
            var banner = document.getElementById('cookie-banner');
            if (banner) banner.style.display = 'block';
        }, 1200); // 1.2s de retraso org├ínico al entrar por primera vez
    }
}

window.acceptCookies = (all) => {
    // Guardar opci├│n ('all' o 'essential') durante 1 a├▒o
...
// ÔöÇÔöÇ NAVBAR ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ VISTAS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
function setupSearch() {
    ...
    if (form) {
        form.onsubmit = async (e) => {
            ...
            if (inDate && outDate && new Date(inDate) > new Date(outDate)) {
...
// ÔöÇÔöÇ HABITACIONES ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

async function loadRooms() {
    var wrapper = document.getElementById('rooms-wrapper');
    if (!wrapper) return;

    var tipoLabels = { NORMAL: 'Habitaci├│n Normal', DOBLE: 'Habitaci├│n Doble', SUITE: 'Suite', LUJO: 'Suite de Lujo' };
    ...
    // Disponibilidad real por tipo (solo cuando hay fechas de b├║squeda)
        ...
        slide.innerHTML = `
            <div class="room-card">
                ...
                <div class="room-card-body">
                    ...
                    <p class="room-price">${h.precio}Ôé¼ <small>/ noche</small></p>
...
// ÔöÇÔöÇ SERVICIOS ÔÇö cargados desde backend ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ ROOM SERVICE ITEMS ÔÇö cargados desde backend ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
function buildCartaHtml(items) {
    ...
    if (disponibles.length === 0) return '<p style="color:var(--text-muted-custom); font-size:0.8rem; letter-spacing:1px;">No hay ├¡tems disponibles en la carta.</p>';
        ...
        return `
            ...
            ${catItems.map(item => `
                <div class="rs-item-row" style="display:flex; align-items:center; gap:10px; margin-bottom:8px;">
                    ...
                    <span style="color:var(--gold); font-size:0.83rem; flex-shrink:0;">${parseFloat(item.precio).toFixed(2)} Ôé¼</span>
                    <div style="display:flex; align-items:center; gap:6px; flex-shrink:0;">
                        <button type="button" onclick="rsAjustarCantidad(${item.id}, -1)"
                            style="background:rgba(255,255,255,0.07); border:1px solid rgba(185,149,77,0.3); color:var(--cream); width:24px; height:24px; border-radius:4px; cursor:pointer; font-size:1rem; line-height:1; padding:0;">ÔêÆ</button>
...
// Funci├│n global para recalcular (usada tanto por servicios como por room service)
        ...
        <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="${i * 80}">
            <div class="servicio-card servicio-card--clickable servicio-card--img" onclick="openServicioDetail(${s.id})" ${bgStyle}>
                ...
                <div class="servicio-card-content">
                    ...
                    <p class="servicio-price">${parseFloat(s.precio).toFixed(2)} Ôé¼</p>
                    <p class="servicio-card-hint">Ver detalle ÔåÆ</p>
                </div>
            </div>
        </div>`;
    }).join('');
...
// ÔöÇÔöÇ VISTA DE DETALLE POR TIPO ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.selectRoom = async (tipo, precio, descripcion) => {
    ...
    // Si ya hay fechas de b├║squeda, mostrarlas directamente; si no, mostrar selector
    ...
    var fechasHtml = state.searchDates
        ? `<div style="margin-bottom:16px; color:var(--text-muted-custom); font-size:0.85rem; letter-spacing:1px;">
               Fechas seleccionadas: <strong style="color:var(--cream);">${fechaEntrada}</strong> ÔåÆ <strong style="color:var(--cream);">${fechaSalida}</strong>
           </div>`
        ...
        : servicios.map(s => {
            ...
            <label style="display:flex; align-items:center; gap:10px; margin-bottom:10px; cursor:pointer; font-size:0.85rem; color:var(--cream);">
                <input type="checkbox" class="servicio-check"
                    ...
                    style="accent-color:var(--gold); width:16px; height:16px; cursor:pointer;">
                <span>${s.nombre}</span>
                <span style="color:var(--gold); margin-left:auto; flex-shrink:0;">${parseFloat(s.precio).toFixed(2)} Ôé¼</span>
            </label>`;
        }).join('');

    showDynamic(`
        <div class="detail-view-container" data-aos="fade-up">
            <p class="section-label mb-1">Hotel DAW ┬À Nuestras Suites</p>
            ...
            <p class="detail-price">${precio}Ôé¼ <small style="font-size:1rem; color:var(--text-muted-custom);">/ noche</small></p>
    ...
    function recalcularTotal() {
        ...
        if (subtotalRS > 0) {
            if (subtotalLabel) subtotalLabel.textContent = subtotalRS.toFixed(2) + ' Ôé¼';
            if (subtotalLinea) subtotalLinea.textContent = 'Subtotal room service: ' + subtotalRS.toFixed(2) + ' Ôé¼';
        } else {
            if (subtotalLabel) subtotalLabel.textContent = '';
            if (subtotalLinea) subtotalLinea.textContent = '';
        }

        totalEl.textContent = `Total estimado: ${(parseFloat(precio) * noches + totalServicios + subtotalRS).toFixed(2)} Ôé¼`;
    }

    // Asignar como funci├│n global para que rsAjustarCantidad la pueda llamar
...
window.confirmarReserva = async (tipo) => {
    ...
    try {
        ...
        if (res.ok) {
            ...
            // Enviar ├¡tems de room service si hay alguno seleccionado
            ...
            msg.textContent   = '┬íReserva confirmada! Tu habitaci├│n ha sido reservada.';
            btn.textContent   = 'Reservado';
            // Refrescar disponibilidad en la secci├│n principal
            loadRooms();
            ...
            msg.style.display  = 'block';
            msg.style.color    = '#c0392b';
            msg.textContent    = 'Error al procesar la reserva. Int├®ntalo de nuevo.';
            btn.disabled       = false;
            btn.textContent    = 'Confirmar Reserva';
        }
    } catch (_) {
        msg.style.display  = 'block';
        msg.style.color    = '#c0392b';
        msg.textContent    = 'Error de conexi├│n. Int├®ntalo de nuevo.';
        btn.disabled       = false;
        btn.textContent    = 'Confirmar Reserva';
    }
};
...
// ÔöÇÔöÇ HELPERS MIS RESERVAS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇ MIS RESERVAS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.showMisReservas = async () => {
    ...
    try {
        ...
        document.getElementById('reservas-container').textContent = 'Error de conexi├│n.';
        return;
    }
    ...
    if (!reservas || reservas.length === 0) {
        container.innerHTML = `
            <div class="reserva-empty">
                <p class="reserva-empty-title">Todav├¡a no tienes reservas</p>
    ...
    reservas.forEach(r => {
        ...
        var serviciosHtml = (r.servicios && r.servicios.length > 0)
            ? `<p class="reserva-meta" style="margin-top:4px; font-size:0.75rem;">
                   Servicios: ${r.servicios.map(s => `${s.nombre} ├ù${s.cantidad}`).join(' ┬À ')}
               </p>`
            : '';
        ...
        var gestionRsBtn = (estado === 'PROXIMA' || estado === 'EN_CURSO')
            ? `<button class="admin-btn" style="margin-top:8px; font-size:0.75rem; padding:6px 14px;" onclick="abrirGestionRS(${r.id})">­ƒì¢ Gestionar Room Service</button>`
            : '';
        ...
        var rsSubtotalStr = r.subtotalRoomService && parseFloat(r.subtotalRoomService) > 0
            ? `<p class="reserva-meta" style="font-size:0.75rem;" id="rs-info-${r.id}">
                   Room Service: <strong style="color:var(--gold);">${parseFloat(r.subtotalRoomService).toFixed(2)} Ôé¼</strong>
               </p>`
                ...
                <div class="reserva-card-body">
                    <div class="reserva-card-header">
                        <div>
                            ...
                            <p class="reserva-hab-num">Habitaci├│n n┬║ ${r.habitacionNumero}</p>
                        </div>
                    ...
                    <p class="reserva-meta">
                        ${noches} noche${noches > 1 ? 's' : ''} &nbsp;┬À&nbsp;
                        Total: <strong>${total} Ôé¼</strong>
                    </p>
                    ${serviciosHtml}
                    ${rsSubtotalStr}
                    ${gestionRsBtn}
...
window.cancelarReserva = async (id) => {
    ...
    try {
        ...
        if (res.ok || res.status === 204) {
            ...
            alert('No se pudo cancelar la reserva. Int├®ntalo de nuevo.');
        }
    } catch (_) {
...
// ÔöÇÔöÇ GESTI├ôN ROOM SERVICE DESDE MIS RESERVAS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.abrirGestionRS = async (reservaId) => {
    ...
    // Mapa pedidoId ÔåÆ cantidad actual para ├¡tems ya pedidos
    var pedidoMap = {};
    ...
    modalEl.innerHTML = `
        <div style="background:#141414;border:1px solid rgba(185,149,77,0.35);border-radius:14px;padding:28px;width:100%;max-width:480px;max-height:85vh;overflow-y:auto;">
            ...
            ${cartaRows || '<p style="color:var(--text-muted-custom);font-size:0.8rem;">No hay ├¡tems disponibles.</p>'}
...
function grsActualizarSubtotal() {
    ...
    if (el) el.textContent = subtotal > 0 ? 'Subtotal: ' + subtotal.toFixed(2) + ' Ôé¼' : '';
}
...
window.guardarPedidoRS = async (reservaId) => {
    ...
    try {
        ...
        msgEl.textContent   = 'Error al guardar. Int├®ntalo de nuevo.';
    }
};

// ÔöÇÔöÇ PANEL ADMIN ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

window.showAdmin = async () => {
    showDynamic(`
        <p class="section-label">Panel de Control</p>
        <h2 class="serif mb-2" style="color:var(--cream); font-size:2.5rem;">Administraci├│n</h2>
...
// ÔöÇÔöÇ ADMIN: DASHBOARD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

async function loadAdminDashboard() {
    var body = document.getElementById('admin-tab-body');
    var res;
    try { res = await fetch('/api/admin/stats'); } catch (_) {
        body.innerHTML = '<p style="color:#c0392b;">Error de conexi├│n.</p>'; return;
    }
    if (!res.ok) { body.innerHTML = '<p style="color:#c0392b;">No se pudieron cargar las m├®tricas.</p>'; return; }
    ...
    var proximasHtml = s.proximasLlegadas && s.proximasLlegadas.length > 0
        ? `<table class="admin-table mt-3">
               <thead><tr><th>Cliente</th><th>Habitaci├│n</th><th>Tipo</th><th>Llegada</th><th>Salida</th></tr></thead>
               <tbody>
        ...
        : '<p style="color:var(--text-muted-custom); font-size:0.8rem; margin-top:12px; letter-spacing:1px;">No hay llegadas pr├│ximas.</p>';
    ...
    body.innerHTML = `
        <div class="admin-stats-grid">
            ...
            <div class="admin-stat-card">
                ...
                <p class="admin-stat-value">${parseFloat(s.ingresosMes).toFixed(2)} Ôé¼</p>
            </div>
            <div class="admin-stat-card">
                <p class="admin-stat-label">Ocupaci├│n hoy</p>
                <p class="admin-stat-value">${s.ocupadasHoy} / ${s.totalHabitaciones} <small style="font-size:1rem;">(${ocupPct}%)</small></p>
            </div>
        </div>

        <div class="mt-5">
            <p style="font-size:0.75rem; letter-spacing:2px; color:var(--text-muted-custom); margin-bottom:4px;">PR├ôXIMAS LLEGADAS</p>
            <div class="gold-line" style="width:60px; margin-bottom:0;"></div>
            ${proximasHtml}
        </div>`;
}

// ÔöÇÔöÇ ADMIN: RESERVAS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
async function loadAdminReservas() {
    ...
    body.innerHTML = `
        <table class="admin-table">
            <thead>
                <tr>
                    <th>#</th><th>Cliente</th><th>Habitaci├│n</th><th>Llegada</th><th>Salida</th>
            ...
            <tbody>
                ${reservas.map(r => {
                    ...
                    return `<tr>
                        <td>${r.id}</td>
                        <td><span style="color:var(--cream);">${r.clienteNombre || 'ÔÇö'}</span><br><small style="color:var(--text-muted-custom);">${r.clienteEmail || ''}</small></td>
                        <td><span class="admin-badge">${tipoLabels[r.habitacionTipo] || r.habitacionTipo}</span> n┬║ ${r.habitacionNumero}</td>
                        <td>${formatFecha(r.fechaEntrada)}</td>
                        <td>${formatFecha(r.fechaSalida)}</td>
                        <td style="font-size:0.75rem;">${serviciosStr}</td>
                        <td style="color:var(--gold); white-space:nowrap;">${parseFloat(r.total).toFixed(2)} Ôé¼</td>
...
window.adminCancelarReserva = async (id) => {
    if (!confirm('┬┐Cancelar esta reserva? Esta acci├│n no se puede deshacer.')) return;
    try {
        var res = await fetch('/api/reservas/' + id, { method: 'DELETE' });
        if (res.ok || res.status === 204) {
            loadAdminReservas();
...
// ÔöÇÔöÇ ADMIN: HABITACIONES (por tipo) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

var TIPO_LABELS_ADMIN = {
    NORMAL: { label: 'Habitaci├│n Normal' },
    DOBLE:  { label: 'Habitaci├│n Doble'  },
    SUITE:  { label: 'Suite'             },
...
async function loadAdminHabitaciones() {
    ...
    var cardsHtml = tipoOrder.map(tipo => {
        ...
        var precio    = lista.length > 0 ? parseFloat(lista[0].precioNoche).toFixed(2) : 'ÔÇö';
        ...
        <div style="position:relative; border-radius:14px; overflow:hidden; min-height:260px; display:flex; flex-direction:column; justify-content:flex-end; ${bgStyle} box-shadow:0 4px 24px rgba(0,0,0,0.35);">
            ...
            <div style="position:relative; padding:20px 22px 22px;">
                ...
                <p style="margin:0 0 4px; font-size:1.6rem; color:var(--gold); font-weight:700; line-height:1;">${precio} <small style="font-size:0.85rem; color:rgba(255,255,255,0.5); font-weight:400;">Ôé¼/noche</small></p>
                <p style="margin:0 0 16px; font-size:0.75rem; color:rgba(255,255,255,0.55); min-height:18px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${desc || 'Sin descripci├│n'}</p>
                <button class="admin-btn" onclick="abrirModalTipo('${tipo}', ${precioVal}, '${descEsc}')" style="width:100%;">Editar habitaci├│n</button>
            </div>
        </div>`;
    }).join('');
        ...
        <div id="modal-tipo-hab" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.75); z-index:9999; align-items:center; justify-content:center;">
            <div style="background:#1a1a1a; border:1px solid rgba(185,149,77,0.3); border-radius:12px; padding:32px; width:100%; max-width:460px; margin:16px;">
                ...
                <p style="font-size:0.72rem; letter-spacing:1px; color:var(--text-muted-custom); margin-bottom:24px;">
                    Los cambios se aplicar├ín a <strong style="color:var(--gold);">todas</strong> las habitaciones de este tipo.
                </p>
                <div class="mb-3">
                    <label class="admin-form-label">Precio / noche (Ôé¼)</label>
                    <input type="number" id="tipo-precio" class="admin-form-input" step="0.01" min="0" placeholder="Ej: 120.00">
                </div>
                <div class="mb-4">
                    <label class="admin-form-label">Descripci├│n (opcional)</label>
                    <input type="text" id="tipo-descripcion" class="admin-form-input" placeholder="Descripci├│n breve del tipo">
                </div>
...
window.abrirModalTipo = (tipo, precio, descripcion) => {
    ...
    var info = TIPO_LABELS_ADMIN[tipo] || { label: tipo, icon: '­ƒÅ¿' };
...
window.guardarTipoHabitacion = async () => {
    ...
    try {
        ...
        if (res.ok) {
            ...
            errEl.textContent = 'No existe ninguna habitaci├│n de ese tipo.';
            errEl.classList.remove('d-none');
        } else {
            errEl.textContent = 'Error al guardar. Int├®ntalo de nuevo.';
            errEl.classList.remove('d-none');
        }
    } catch (_) {
...
// ÔöÇÔöÇ ADMIN: SERVICIOS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    body.innerHTML = `
            ...
            <tbody>
                ${servicios.map(s => `
                    <tr>
                        ...
                        <td style="color:var(--gold);">${parseFloat(s.precio).toFixed(2)} Ôé¼</td>
        ...
        <div id="modal-servicio" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.7); z-index:9999; align-items:center; justify-content:center;">
            <div style="background:#1a1a1a; border:1px solid rgba(185,149,77,0.3); border-radius:12px; padding:32px; width:100%; max-width:400px;">
                ...
                <div class="mb-4">
                    <label class="admin-form-label">Precio (Ôé¼)</label>
...
// ÔöÇÔöÇ ADMIN: ROOM SERVICE ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
async function loadAdminRoomService() {
    ...
    if (!res.ok) { body.innerHTML = '<p style="color:#c0392b;">No se pudieron cargar los ├¡tems.</p>'; return; }
    var items = await res.json();
    _rsItemsCache = null; // invalidar cach├® del frontend al editar desde admin
    ...
    var tablasPorCat = categorias.map(cat => {
        ...
        return `
            ...
            <table class="admin-table">
                <thead><tr><th>#</th><th>Nombre</th><th>Descripci├│n</th><th>Precio</th><th>Disponible</th><th></th></tr></thead>
                <tbody>
                    ${catItems.map(item => `
                        <tr>
                            <td>${item.id}</td>
                            <td style="color:var(--cream);">${item.nombre}</td>
                            <td style="color:var(--text-muted-custom);font-size:0.75rem;">${item.descripcion || 'ÔÇö'}</td>
                            <td style="color:var(--gold);">${parseFloat(item.precio).toFixed(2)} Ôé¼</td>
                            <td>${item.disponible ? '<span class="admin-badge" style="color:#27ae60;">S├¡</span>' : '<span class="admin-badge" style="color:#c0392b;">No</span>'}</td>
                            <td style="white-space:nowrap;">
    ...
    body.innerHTML = `
        <div class="mb-3">
            <button class="admin-btn" onclick="abrirModalRSItem(null)">+ Nuevo ├¡tem</button>
        </div>
        ${tablasPorCat || '<p style="color:var(--text-muted-custom);font-size:0.8rem;letter-spacing:1px;margin-top:12px;">No hay ├¡tems en la carta.</p>'}

        <!-- Modal ├¡tem room service -->
        <div id="modal-rs-item" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.75);z-index:9999;align-items:center;justify-content:center;">
            <div style="background:#1a1a1a;border:1px solid rgba(185,149,77,0.3);border-radius:12px;padding:32px;width:100%;max-width:460px;margin:16px;max-height:90vh;overflow-y:auto;">
                <h3 class="serif mb-4" id="modal-rsitem-title" style="color:var(--cream);">├ìtem Room Service</h3>
                <div class="mb-3">
                    <label class="admin-form-label">Nombre</label>
                ...
                <div class="mb-3">
                    <label class="admin-form-label">Descripci├│n (opcional)</label>
                    <input type="text" id="rsi-descripcion" class="admin-form-input" placeholder="Breve descripci├│n del plato">
                </div>
                <div class="mb-3">
                    <label class="admin-form-label">Precio (Ôé¼)</label>
...
window.abrirModalRSItem = (item) => {
    ...
    document.getElementById('modal-rsitem-title').textContent = item ? 'Editar ├¡tem' : 'Nuevo ├¡tem';
...
window.guardarRSItem = async () => {
    ...
    try {
        ...
        if (res.ok || res.status === 201) {
            ...
            errEl.textContent = '├ìtem no encontrado.';
            errEl.classList.remove('d-none');
        } else {
            errEl.textContent = 'Error al guardar.';
            errEl.classList.remove('d-none');
...
window.adminEliminarRSItem = async (id) => {
    if (!confirm('┬┐Eliminar este ├¡tem de la carta?')) return;
    try {
        ...
        if (res.ok || res.status === 204) {
            ...
            alert('No se puede eliminar: hay pedidos activos que usan este ├¡tem. M├írcalo como no disponible primero.');
        } else {
...
// ÔöÇÔöÇ ADMIN: USUARIOS ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        <table class="admin-table">
            ...
            <tbody>
                ${usuarios.map(u => `
                    <tr>
                        <td>${u.id}</td>
                        <td style="color:var(--cream);">${u.nombre || 'ÔÇö'}</td>
...
window.adminEliminarUsuario = async (id) => {
    if (!confirm('┬┐Eliminar este usuario? Se cancelar├ín todas sus reservas.')) return;
    try {
...
// ÔöÇÔöÇ AUTH MODAL ÔÇö pendiente de backend ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.handleLogin = async (e) => {
    ...
    if (!emailRegex.test(email)) {
        showAuthError('Por favor, introduce un formato de email v├ílido.');
        return;
    }
    ...
    // Spring Security redirige a /login?error si falla
    if (res.url && res.url.includes('error')) {
        showAuthError('Email o contrase├▒a incorrectos.');
    } else if (res.ok || res.redirected) {
        window.location.reload();
    } else {
        showAuthError('Error al iniciar sesi├│n.');
    }
};
...
window.handleRegister = async (e) => {
    ...
    // Validaci├│n Regex
    const nombreRegex = /^(?=.{2,50}$)[a-zA-Z├í├®├¡├│├║├ü├ë├ì├ô├Ü├▒├æ\s]+(?:-[a-zA-Z├í├®├¡├│├║├ü├ë├ì├ô├Ü├▒├æ\s]+)*$/;
    if (!nombreRegex.test(nombre)) {
        showAuthError('El nombre solo puede contener letras, espacios o guiones medios (no terminales). M├¡nimo 2 caracteres.');
        return;
    }
    ...
    if (!passwordRegex.test(password)) {
        showAuthError('La contrase├▒a debe tener al menos 6 caracteres, incluir una may├║scula y un n├║mero.');
        return;
    }
...
// ÔöÇÔöÇ ROOM LIGHTBOX ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.openRoomLightbox = (name, tipo, price) => {
    ...
    lb.querySelector('.room-lightbox-price').textContent = price + 'Ôé¼ / noche';
    lbRender(false);
...
// ÔöÇÔöÇ SERVICIO DETAIL PAGE ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
window.openServicioDetail = async function(id) {
    ...
    var horario         = data ? data.horario        : 'ÔÇô';
    var capacidad       = data ? data.capacidad      : 'ÔÇô';
    var caracteristicas = data && data.caracteristicas
        ? data.caracteristicas.map(c => `<li>Ô£ª ${c}</li>`).join('')
        : '';

    showDynamic(`
        <div class="servicio-detail-page">

            <button class="btn-volver" onclick="backToServicios()">ÔåÉ Volver a Servicios</button>

            <div class="servicio-detail-header">
                <div>
                    <p class="section-label mb-0">Hotel DAW ┬À Nuestros Servicios</p>
                    <h2 class="servicio-detail-titulo serif">${nombre}</h2>
                </div>
                <div class="servicio-detail-precio-badge">
                    <span class="servicio-detail-precio">${precio} Ôé¼</span>
