# Spec: habitacion-detail-view

## Purpose

Vista de detalle de habitaciones conectada a datos reales desde la API. Permite al usuario navegar desde el carrusel principal a una vista de detalle por tipo de habitación, mostrando imágenes, precio, descripción y disponibilidad obtenidos de Supabase.
