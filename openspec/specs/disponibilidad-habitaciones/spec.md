# Spec: Disponibilidad de Habitaciones

## Purpose

Exponer la disponibilidad real de habitaciones por tipo para un rango de fechas dado, tanto a través de un endpoint de API como en la interfaz de usuario del frontend.
