...
Gestionar el catálogo de servicios adicionales (como desayuno, parking, limpieza extra) que el hotel ofrece a sus huéspedes. Incluye endpoints para que el administrador gestione el catálogo y para que los clientes consulten los servicios disponibles.
